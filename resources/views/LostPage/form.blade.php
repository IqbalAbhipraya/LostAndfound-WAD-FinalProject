...
<div class="max-w-md mx-auto bg-white rounded-lg shadow-md p-6 m-10">
    <h2 class="text-2xl font-bold text-gray-900 mb-6 text-center">Report Lost Item</h2>

    <form class="space-y-6" action="{{ route('lost-items.store') }}" method="POST" enctype="multipart/form-data" id="lostItemForm">
        @csrf
        <!-- Item Name -->
        <div>
        ...
        <div>
            ...
            <select id="claim_status" name="claim_status" class="form-select" required>
